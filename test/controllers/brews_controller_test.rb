...
class BrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brew" do
    assert_difference('Brew.count') do
      post brews_url, params: { brew: { brewdate: @brew.brewdate, brewstyle: @brew.brewstyle, name: @brew.name, notes: @brew.notes, version: @brew.version } }
    end
  ...
  test "should update brew" do
    patch brew_url(@brew), params: { brew: { brewdate: @brew.brewdate, brewstyle: @brew.brewstyle, name: @brew.name, notes: @brew.notes, version: @brew.version } }
